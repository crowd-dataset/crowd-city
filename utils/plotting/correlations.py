...
class Correlations:
    ...
    def correlation_matrix(self, df_mapping, ped_cross_locality, person_locality, bicycle_locality, car_locality,
        ...
        rename_dict_1 = {
            'avg_speed_0': crossing_metric_label(), 'avg_speed_1': crossing_metric_label(),
        ...
        rename_dict_2 = {
            'avg_speed_val': crossing_metric_label(), 'avg_time_val': 'Crossing initiation time',
    ...
    def correlation_matrix_country(self, df_mapping, df_countries, ped_cross_locality, person_locality,
        ...
        # Rename the variables in the correlation matrix
        rename_dict_1 = {
            'avg_speed_0': crossing_metric_label(),
            'avg_speed_1': crossing_metric_label(),
        ...
        # Rename the variables in the correlation matrix (example: renaming keys)
        rename_dict_2 = {
            'avg_day_night_speed': crossing_metric_label(),
